...
- Si no adelantaste tu proyecto de Supabase en Semana 0, hazlo primero ([Supabase paso a paso](/docs/setup/supabase)) — el Quick start te lo pide antes del Paso 1.
- Puedes **saltarte el Paso 6** (subir el schema): la landing corre sin base de datos, y ese paso toca en [Semana 2](/docs/tutoriales/semana-2-mvp).
