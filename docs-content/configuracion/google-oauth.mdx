...
- **Authentication** → **URL Configuration** → en **Site URL** pon la URL de tu deploy (la de Vercel o tu dominio propio), y en **Redirect URLs** agrega esa misma URL **con `/auth/callback` al final** (ej. `https://tu-producto.vercel.app/auth/callback`).
