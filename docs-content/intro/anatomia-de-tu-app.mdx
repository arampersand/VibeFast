...
Se configuran una vez y se explican paso a paso aquí → [Variables de entorno](/docs/setup/variables-de-entorno). Y como son secretas, hay una página sobre cuidarlas → [Seguridad básica](/docs/fundamentos/seguridad-basica).
