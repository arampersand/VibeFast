...
3. <Term id="nextjs">Next.js</Term> recibe la petición y decide qué hacer.
4. Si hacen falta datos, **consulta a <Term id="supabase">Supabase</Term>** (la despensa).
...
- **Producción** — tu app **publicada en <Term id="vercel">Vercel</Term>**, con una URL real que cualquiera puede abrir. El estreno público.
