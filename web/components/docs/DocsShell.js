    ...
    <ProgressProvider>
      <div className="drawer mx-auto max-w-7xl lg:drawer-open">
        ...
        <div className="drawer-side z-30">
          ...
          {/* scrollbar-gutter: al expandir un módulo aparecía la barra de scroll
              y le quitaba ~15px de ancho al sidebar, re-acomodando todo el texto.
              Reservando el hueco siempre, el ancho no cambia al abrir/cerrar. */}
          <aside className="min-h-full w-64 bg-base-100 p-4 lg:sticky lg:top-20 lg:min-h-0 lg:max-h-[calc(100vh-6rem)] lg:overflow-y-auto lg:[scrollbar-gutter:stable] lg:bg-transparent lg:pl-0">
